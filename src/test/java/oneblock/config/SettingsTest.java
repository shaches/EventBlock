...
/**
 * Defaults + volatility coverage for {@link Settings}, the Phase 3 typed bag that replaced ~17
 * {@code public static volatile} fields on {@link oneblock.Oneblock}. {@code Settings} is
 * intentionally Bukkit-free (no {@code Plugin}/{@code World}/etc. dependencies) so this suite stays
