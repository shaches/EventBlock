...
/**
 * Covers the Phase 2 reverse-index contract added to {@link PlayerInfo}: O(1) {@code getId}, index
 * maintenance on {@code set}/{@code replaceAll}/ {@code removeUUID}/{@code addInvite}/{@code
 * removeInvite}, and the top-list version counter bumped by mutations.
 */
