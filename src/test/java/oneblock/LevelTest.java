...
/**
 * Covers the static-state contract of {@link Level}: lookup fallback to {@link Level#max},
 * pool-size reflection, multiplier default, {@link Level#getId} fallback on a detached instance,
 * and {@link Level#resetPools} atomicity.
 *
 * <p>{@code Level} holds mutable statics ({@code levels}, {@code max}, {@code multiplier}); each
 * test snapshots and restores them to avoid leaking state to sibling tests in the suite.
 */
class LevelTest {
