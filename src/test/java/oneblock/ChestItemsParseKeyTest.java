...
/**
 * {@link ChestItems#parseKey(String)} is a tolerant parser for vanilla loot-table identifiers. The
 * contract:
 *
 * <p>- accepts {@code minecraft:path} and {@code ns:path} - falls back to {@code minecraft} when
 * the colon is missing - lowercases the input - returns {@code null} on empty / malformed inputs
 * instead of throwing
 */
