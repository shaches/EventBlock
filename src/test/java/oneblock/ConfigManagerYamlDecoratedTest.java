...
class ConfigManagerYamlDecoratedTest {
  ...
  @Test
  @DisplayName("new-schema levels parse boss-bar color and style")
  void parseNewSchemaLevelColorAndStyle() {
    String yaml =
        "levels:\n"
            + "  mines:\n"
            + "    name: '&8The Mines'\n"
    ...
    Level level = cm.parseNewLevel(cfg.getConfigurationSection("levels.mines"), "mines");
