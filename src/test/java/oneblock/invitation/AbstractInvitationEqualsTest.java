...
/**
 * Phase 3.7 added {@link AbstractInvitation#hashCode()} matching the existing {@link
 * AbstractInvitation#equals(Object)} contract (pair of inviter + invitee UUIDs). This suite pins
 * the contract so the two methods can never silently diverge.
 *
 * <p>{@code AbstractInvitation} is abstract so the tests use the concrete {@link Invitation}
 * subclass which adds a TTL but does not override equals/hashCode.
 */
