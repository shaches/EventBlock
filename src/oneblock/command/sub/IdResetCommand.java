 ...
 *
 * <p>With one or more args, this command falls through to the {@link AdminIdResetCommand} (which
 * performs the {@code Oneblock.set} permission check internally) - matches the legacy switch
 * fall-through chain from {@code idreset} to {@code default}.
 */
