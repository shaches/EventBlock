...
/**
 * {@code /ob invite <player>} - user-facing. Sends a co-owner invite to the named online player.
 * The invitee gets a chat prompt + GUI; the inviter gets a confirmation. Cap-checked against {@code
 * settings().maxPlayersTeam} (zero = unlimited).
 *
 * <p>Behaviour-equivalent to the legacy {@code "invite"} switch case extracted in Phase 3.5b.
 * Requires {@code Oneblock.invite} and a {@link Player} sender (console has no island to invite
 * TO).
 */
