...
public final class Settings {
  ...
  @SuppressFBWarnings(
      ...
      justification =
          "This field is used by LegacyBlocksMigrator.migrateBlocks() to control migration"
              + " behavior. Spotbugs may not detect usage in separate package or test code. The"
              + " field is part of the public API for migration configuration.")
