  ...
  @SuppressFBWarnings(
      ...
      justification =
          "Legacy static field for backward compatibility during Phase 3 migration. This field"
              + " mirrors config.chest and is retained for legacy code that directly accesses"
              + " ChestItems.chest instead of using the config-based accessor. Will be removed in a"
              + " future phase once all callers are migrated to the config-based pattern.")
  public static File chest = config.chest;
