...
/**
 * Phase 3.7 added {@link PlayerInfo#equals(Object)} + {@link PlayerInfo#hashCode()} keyed on the
 * owner UUID. This suite pins the contract so a future change to per-island mutable state (level /
 * breaks / member list) cannot accidentally tighten or loosen the equality definition.
 */
