...
/**
 * Record-semantics + helper coverage for {@link IslandOrigin}, the immutable atomic-swap unit that
 * replaced the four {@code Oneblock.x/y/z/offset} static fields. Does not touch {@link Oneblock}
 * itself so this suite remains fast and has no Bukkit wiring cost.
 */
